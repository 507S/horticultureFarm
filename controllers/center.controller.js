...
module.exports.specialCoconutEdit = async(req,res) => {
  await specialCoconut.findByPk(req.params.id)
    .then((data) => {
      res.render(
        'center/specialCoconut/specialCoconutEdit', {
        title: "বিশেষ নারিকেল কর্মসূচি",
        msg: "",
        success: "",
        user_id: req.session.user_id,
...
module.exports.revolvingFundEdit = async(req,res) => {
  await revolvingFund.findByPk(req.params.id)
    .then((data) => {
      res.render(
        "center/revolvingFund/revolvingFundEdit",
        {
          records: data,
          title: "রিভলভিং ফান্ড ফর্ম",
          msg: "",
...
module.exports.expense = async (req, res) => {
  ...
  try {
    console.log("expense");
    res.render("center/expense/expense", { title: "খরচের (বি-স্টেটমেন্ট) হিসাব বিবরণী", success: "", records: data, codes: codess })
  }
  catch {
    console.log(err);
  };
...
module.exports.monthlyProgressUpdate = async (req, res) => {
  try {
    ...
    const data = await monthlyProgress
      .update(
        {
          category: categoryName.name,
          subCategory: subCategoryName.name,
